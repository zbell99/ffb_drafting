...
class draft_monitor:
    ...
    def update_rosters(self,specific_team=None):
        ...
        """
        dropdown_element = self.driver.find_element("xpath", '/html/body/div[1]/div[1]/section/div/div[2]/main/div/div/div[3]/div[1]/div[1]/div[2]/div[1]/div/select')
        ...
        for t in teams:
            dropdown.select_by_visible_text(t.text)
            
        if specific_team is None:
            for i in range(len(teams)):
                dropdown.select_by_index(i)
                team_ele = self.driver.find_element("xpath","/html/body/div[1]/div[1]/section/div/div[2]/main/div/div/div[3]/div[1]/div[1]/div[2]/div[2]/div/div/div/div/div[2]/table/tbody/tr")
